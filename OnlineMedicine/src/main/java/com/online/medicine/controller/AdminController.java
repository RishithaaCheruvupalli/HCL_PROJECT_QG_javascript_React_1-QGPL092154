...
import com.online.medicine.service.AdminService;
...
public class AdminController {
	...
	public List<String> createUser(@RequestBody Admin user) {
	...
	public List<String> updateUser(@RequestBody Admin user,@PathVariable("id") Integer id) {
		user.setUserId(id);
